...
$(document).ready(function () {
    datatables = $('#emptable').DataTable({
        "ajax": {
            "url": "/VerifyCompany/VerifyPendingCompanyList",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...

            {
                ...
                "render": function (data) {
                    return `<div class='text-center'>                                             
                        <a class='btn btn-secondary text-white' style=' background-color: #8E24AA' onClick=Approve('/VerifyCompany/ApproveCompany?id=${data}') title='Approve company' style='cursor:pointer' ><span class='fas fa-check'></span> Approve</a>
...
function Approve(path) {
    swal({
        title: "Do you want to approve this company?",
